...
const ScriptToVideo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiService.generateFromScript(formData);
  ...
  return (
    <div className="card" data-testid="script-to-video-form">
      <div className="mb-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <p className="mt-2 text-xs text-gray-500">
            Use standard screenplay format (e.g., EXT. SCHOOL GYM - DAY)
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="E.g., Fast-paced with no more than 15 shots"
            />
          </div>
        ...
        <button
          type="submit"
          disabled={loading || !formData.script}
